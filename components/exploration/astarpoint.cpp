...
void Astarpoint(const int startx,const int starty,const int goalx,const int goaly, const unsigned char cost_map[], double & dist_traveled, vector<Traj_pt_s> & bestpath ) {
	// returns path 
