...
switch event
  case 'entry'
    ...
    GDISPLAY.servoLabel = uicontrol(Std, ...
                                'Parent', GDISPLAY.grp, ...
                                'Style', 'text', ...
                                'String', 'Servo?', ...
                                'KeyPressFcn', @keypress, ...
    ...
    GDISPLAY.robotStatusText{1} = uicontrol(Std, ...
                                ...
                                'Units', 'Normalized', ...
                                'Position', [.3 .865 .5 .1]);
    GDISPLAY.robotServoControl{1} = uicontrol(Std, ...
                                'Parent', GDISPLAY.grp, ...
                                'Style', 'checkbox', ...
                                'KeyPressFcn', @keypress, ...
                                'Callback', ['sendUseServo(1)'], ...
                                'Enable', 'off', ...
                                'Units', 'Normalized', ...
                                'Position', [.85 .93 .1 .04]);
    ...
    GDISPLAY.robotStatusText{2} = uicontrol(Std, ...
                                ...
                                'Units', 'Normalized', ...
                                'Position', [.3 .765 .5 .1]);
    GDISPLAY.robotServoControl{2} = uicontrol(Std, ...
                                'Parent', GDISPLAY.grp, ...
                                'Style', 'checkbox', ...
                                'KeyPressFcn', @keypress, ...
                                'Callback', ['sendUseServo(2)'], ...
                                'Enable', 'off', ...
                                'Units', 'Normalized', ...
                                'Position', [.85 .8 .1 .1]);
    ...
    GDISPLAY.robotStatusText{3} = uicontrol(Std, ...
                                ...
                                'Units', 'Normalized', ...
                                'Position', [.3 .665 .5 .1]);
    GDISPLAY.robotServoControl{3} = uicontrol(Std, ...
                                'Parent', GDISPLAY.grp, ...
                                'Style', 'checkbox', ...
                                'KeyPressFcn', @keypress, ...
                                'Callback', ['sendUseServo(3)'], ...
                                'Enable', 'off', ...
                                'Units', 'Normalized', ...
                                'Position', [.85 .7 .1 .1]);
    ...
    GDISPLAY.robotStatusText{4} = uicontrol(Std, ...
                                ...
                                'Units', 'Normalized', ...
                                'Position', [.3 .565 .5 .1]);
    GDISPLAY.robotServoControl{4} = uicontrol(Std, ...
                                'Parent', GDISPLAY.grp, ...
                                'Style', 'checkbox', ...
                                'KeyPressFcn', @keypress, ...
                                'Callback', ['sendUseServo(4)'], ...
                                'Enable', 'off', ...
                                'Units', 'Normalized', ...
                                'Position', [.85 .6 .1 .1]);
    ...
    GDISPLAY.robotStatusText{5} = uicontrol(Std, ...
                                ...
                                'Units', 'Normalized', ...
                                'Position', [.3 .465 .5 .1]);
    GDISPLAY.robotServoControl{5} = uicontrol(Std, ...
                                'Parent', GDISPLAY.grp, ...
                                'Style', 'checkbox', ...
                                'KeyPressFcn', @keypress, ...
                                'Callback', ['sendUseServo(5)'], ...
                                'Enable', 'off', ...
                                'Units', 'Normalized', ...
                                'Position', [.85 .5 .1 .1]);
    ...
    GDISPLAY.robotStatusText{6} = uicontrol(Std, ...
                                ...
                                'Units', 'Normalized', ...
                                'Position', [.3 .365 .5 .1]);
    GDISPLAY.robotServoControl{6} = uicontrol(Std, ...
                                'Parent', GDISPLAY.grp, ...
                                'Style', 'checkbox', ...
                                'KeyPressFcn', @keypress, ...
                                'Callback', ['sendUseServo(6)'], ...
                                'Enable', 'off', ...
                                'Units', 'Normalized', ...
                                'Position', [.85 .4 .1 .1]);
    ...
    GDISPLAY.robotStatusText{7} = uicontrol(Std, ...
                                ...
                                'Units', 'Normalized', ...
                                'Position', [.3 .265 .5 .1]);
    GDISPLAY.robotServoControl{7} = uicontrol(Std, ...
                                'Parent', GDISPLAY.grp, ...
                                'Style', 'checkbox', ...
                                'KeyPressFcn', @keypress, ...
                                'Callback', ['sendUseServo(7)'], ...
                                'Enable', 'off', ...
                                'Units', 'Normalized', ...
                                'Position', [.85 .3 .1 .1]);
    ...
    GDISPLAY.robotStatusText{8} = uicontrol(Std, ...
                                ...
                                'Units', 'Normalized', ...
                                'Position', [.3 .165 .5 .1]);
    GDISPLAY.robotServoControl{8} = uicontrol(Std, ...
                                'Parent', GDISPLAY.grp, ...
                                'Style', 'checkbox', ...
                                'KeyPressFcn', @keypress, ...
                                'Callback', ['sendUseServo(8)'], ...
                                'Enable', 'off', ...
                                'Units', 'Normalized', ...
                                'Position', [.85 .2 .1 .1]);
    ...
    GDISPLAY.robotStatusText{9} = uicontrol(Std, ...
                                ...
                                'Units', 'Normalized', ...
                                'Position', [.3 .065 .5 .1]);
    GDISPLAY.robotServoControl{9} = uicontrol(Std, ...
                                'Parent', GDISPLAY.grp, ...
                                'Style', 'checkbox', ...
                                'KeyPressFcn', @keypress, ...
                                'Callback', ['sendUseServo(9)'], ...
                                'Enable', 'off', ...
                                'Units', 'Normalized', ...
                                'Position', [.85 .1 .1 .1]);
    ...
    for id = GCS.ids
      ...
      set(GDISPLAY.robotServoControl{id},'Enable','on');
      set(GDISPLAY.robotServoControl{id},'Value',1);
    end
