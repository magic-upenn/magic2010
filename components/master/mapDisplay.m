...
switch event
  case 'entry'
    ...
    GDISPLAY.ooiRadioControl{1} = uicontrol(Std, ...
                                ...
                                'KeyPressFcn', @keypress, ...
                                'Units', 'Normalized', ...
                                'Position', [.032 .84 .9 .14]);
    GDISPLAY.ooiRadioControl{2} = uicontrol(Std, ...
                                'Parent', GDISPLAY.ooiGroup, ...
                                'Style', 'radiobutton', ...
                                'String', 'Red Bin (Neutralized)', ...
                                'KeyPressFcn', @keypress, ...
                                'Units', 'Normalized', ...
                                'Position', [.032 .70 .9 .14]);
    GDISPLAY.ooiRadioControl{3} = uicontrol(Std, ...
                                ...
                                'KeyPressFcn', @keypress, ...
                                'Units', 'Normalized', ...
                                'Position', [.032 .56 .9 .14]);
    GDISPLAY.ooiRadioControl{4} = uicontrol(Std, ...
                                'Parent', GDISPLAY.ooiGroup, ...
                                'Style', 'radiobutton', ...
                                'String', 'Red Person (Neutralized)', ...
                                'KeyPressFcn', @keypress, ...
                                'Units', 'Normalized', ...
                                'Position', [.032 .42 .9 .14]);
