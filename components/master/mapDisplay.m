...
switch event
  case 'entry'
    ...
    set(GDISPLAY.hFigure,'Position',[1 scrsz(4) scrsz(3) scrsz(4)]);
    clf;
    ...
    Std.Interruptible = 'off';
    Std.BusyAction = 'queue';
    GDISPLAY.stopControl{1} = uicontrol(Std, ...
                                        'Parent', hfig, ...
                                        'Style', 'pushbutton', ...
                                        'String', 'Stop', ...
                                        ...
                                        'Units', 'Normalized', ...
                                        'Position', [.025 .82 .15 .07]);
    GDISPLAY.goToPointControl{1} = uicontrol(Std, ...
                                        'Parent', hfig, ...
                                        'Style', 'pushbutton', ...
                                        'String', 'Go To Point', ...
    ...
    GDISPLAY.exploreControl{1} = uicontrol(Std, ...
                                        'Parent', hfig, ...
                                        'Style', 'pushbutton', ...
    ...
    GDISPLAY.avoidControl{1} = uicontrol(Std, ...
                                        'Parent', hfig, ...
                                        'Style', 'pushbutton', ...
                                        'String', 'Avoid Region', ...
