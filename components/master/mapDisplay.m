...
switch event
  case 'entry'
    ...
    GDISPLAY.ooiOverlay = uicontrol(Std, ...
                                        ...
                                        'KeyPressFcn', @keypress, ...
                                        'Units', 'Normalized', ...
                                        'Position', [.80 .54 .10 .03]);
    GDISPLAY.ooiList = uicontrol(Std, ...
                                        'Parent', hfig, ...
                                        'Style', 'listbox', ...
                                        'KeyPressFcn', @keypress, ...
                                        'Units', 'Normalized', ...
                                        'Position', [.80 .47 .10 .07]);
                                        %{
    ...
    GDISPLAY.avoidOverlay = uicontrol(Std, ...
                                        ...
                                        'KeyPressFcn', @keypress, ...
                                        'Units', 'Normalized', ...
                                        'Position', [.80 .42 .10 .03]);
    GDISPLAY.avoidRegionList = uicontrol(Std, ...
                                        'Parent', hfig, ...
                                        'Style', 'listbox', ...
                                        'KeyPressFcn', @keypress, ...
                                        'Units', 'Normalized', ...
                                        'Position', [.80 .35 .10 .07]);
