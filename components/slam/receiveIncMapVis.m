...
ipcAPI2('connect');
ipcAPI2('define',VIS.mapMsgName,mapMsgFormat);
ipcAPI2('define',VIS.updateRectMsgName,updateRectMsgFormat);
ipcAPI2('define',VIS.updatePointsMsgName,updatePointsMsgFormat);
...
global POSE MAP_FIGURE
  ...
  ipcAPI2('publishVC',POSE.msgName,MagicPoseSerializer('serialize',POSE.data));
