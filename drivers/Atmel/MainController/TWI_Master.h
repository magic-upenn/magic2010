...
#define TWI_TWBR				72        // 72 gives 100 kHz TWI clock for 16 MHz crystal
...
void TWI_Start_Transceiver_With_Data( volatile unsigned char * , unsigned char );
void TWI_Start_Transceiver( void );
unsigned char TWI_Get_Data_From_Transceiver( volatile unsigned char *);
