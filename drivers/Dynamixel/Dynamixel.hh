...
#define DYNAMIXEL_DEFAULT_MIN_ANGLE        -30
#define DYNAMIXEL_DEFAULT_MAX_ANGLE        +30
...
namespace Upenn
{
  ...
  {	
    ...
    //get the time of the last angle
    public: double GetLastAngleTime();
