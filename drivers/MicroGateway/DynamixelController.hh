...
#define DYNAMIXEL_CONTROLLER_ANGLE_CMD_TIMEOUT       0.10
#define DYNAMIXEL_CONTROLLER_FEEDBACK_REQUEST_PERIOD 0.050
#define DYNAMIXEL_CONTROLLER_FB_CMD_TIMEOUT          0.10
