...
//-----------------------------------------------------------------------------
{
	...
	{
		std::cout << "The minimum value of '" << name << "' is " << prop.readS( mvIMPACT::acquire::PROP_MIN_VAL ) << std::endl;
	}
	if( prop.isConstDefined( mvIMPACT::acquire::PROP_MAX_VAL ) )
	{
		std::cout << "The maximum value of '" << name << "' is " << prop.readS( mvIMPACT::acquire::PROP_MAX_VAL ) << std::endl;
	}
	if( prop.isConstDefined( mvIMPACT::acquire::PROP_STEP_WIDTH ) )
	{
		std::cout << "The increment of '" << name << "' is " << prop.readS( mvIMPACT::acquire::PROP_STEP_WIDTH ) << std::endl;
	}
	if( prop.hasDict() )
	{
...
//-----------------------------------------------------------------------------
bool displayPropertyDataWithValidation( const mvIMPACT::acquire::Property& prop, const std::string& name )
//-----------------------------------------------------------------------------
{
	if( !prop.isValid() )
	{
...
//-----------------------------------------------------------------------------
void displayAndModifyPropertyDataWithValidation( const mvIMPACT::acquire::Property& prop, const std::string& name )
//-----------------------------------------------------------------------------
{
