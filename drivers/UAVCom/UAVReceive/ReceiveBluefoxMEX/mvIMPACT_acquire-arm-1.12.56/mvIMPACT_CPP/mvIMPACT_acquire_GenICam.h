...
class DeviceControl : public mvIMPACT::acquire::ComponentCollection
//-----------------------------------------------------------------------------
{
public:
...
class ImageFormatControl : public mvIMPACT::acquire::ComponentCollection
//-----------------------------------------------------------------------------
{
public:
...
class AcquisitionControl : public mvIMPACT::acquire::ComponentCollection
//-----------------------------------------------------------------------------
{
public:
...
class DigitalIOControl : public mvIMPACT::acquire::ComponentCollection
//-----------------------------------------------------------------------------
{
public:
...
class CounterAndTimerControl : public mvIMPACT::acquire::ComponentCollection
//-----------------------------------------------------------------------------
{
public:
	...
	/// \brief Sets the duration (in microseconds) of the delay to apply at the reception of a trigger before to start the Timer.
	///
	/// Sets the duration (in microseconds) of the delay to apply at the reception of a trigger before to start the Timer.
	PropertyF timerDelay;
	/// \brief This feature is deprecated.
	///
	/// This feature is deprecated. This feature sets the duration (in microseconds) of the delay to apply after the reception of a trigger before to start the Timer.
	PropertyF timerDelayAbs;
	/// \brief This feature is deprecated.
	///
	/// This feature is deprecated. It sets the duration in device-specific unit of the delay to apply after the reception of a trigger before to start the Timer.
...
class EventControl : public mvIMPACT::acquire::ComponentCollection
//-----------------------------------------------------------------------------
{
public:
...
class AnalogControl : public mvIMPACT::acquire::ComponentCollection
//-----------------------------------------------------------------------------
{
public:
...
class LUTControl : public mvIMPACT::acquire::ComponentCollection
//-----------------------------------------------------------------------------
{
public:
...
class UserSetControl : public mvIMPACT::acquire::ComponentCollection
//-----------------------------------------------------------------------------
{
public:
...
class ChunkDataControl : public mvIMPACT::acquire::ComponentCollection
//-----------------------------------------------------------------------------
{
public:
...
class FileAccessControl : public mvIMPACT::acquire::ComponentCollection
//-----------------------------------------------------------------------------
{
public:
...
class ColorTransformationControl : public mvIMPACT::acquire::ComponentCollection
//-----------------------------------------------------------------------------
{
public:
...
class ActionControl : public mvIMPACT::acquire::ComponentCollection
//-----------------------------------------------------------------------------
{
public:
