...
StartFunction <<EOF
central:central
gcsGui:matlab -nodesktop -r startGCS_GUI
gcsMap:matlab -nodesktop -r startGCS_MAP
gcsUAV:matlab -nodesktop -r startGCS_UAV
exploration:$MAGIC_DIR/components/exploration/magicwrapper
EOF
